...
$wordsDelimiter = isset($_GET['wordsDelimiter']) ? $_GET['wordsDelimiter'] == 'on' : false;
...
for ($i = 0; $i < $numberOfWords; $i++) {
  $password[] = $wordsDelimiter ? ucfirst($words[$i]) : $words[$i];
}

$password = join($password, $wordsDelimiter ? '' : '-');
